      ...
      <div className={cx("SocialsModule flex justify-end overflow-hidden w100")}>
        ...
        <div>
          <ul className={cx("SocialsModule__nav")}>
            ...
            <li className={cx("SocialsModule__nav--list-item SocialsModule__nav--list-item-svg flex justify-end relative")}>
              ...
              {/* <span className={cx("SocialsModule__nav--list-item-cta-svg absolute headline-serif color-white")}>Water Glass</span> */}
            </li>
