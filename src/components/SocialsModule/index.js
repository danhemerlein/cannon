      ...
      <div className={cx("SocialsModule flex justify-end overflow-hidden w100")}>
        ...
        <div>
          <ul className={cx("SocialsModule__nav")}>
            <li className={cx("SocialsModule__nav--list-item mb1 relative flex justify-end")}>
              <a href="https://itunes.apple.com/us/album/water-glass-single/1454131803?ign-mpt=uo%3D4" target="_blank" rel="noopener noreferrer"><i className="fab fa-apple"></i></a>
            ...
            <li className={cx("SocialsModule__nav--list-item relative flex justify-end")}>
